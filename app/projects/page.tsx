...
export default async function ProjectsPage() {
  ...
  const featured = allProjects.find((project) => project.slug === "asa")!;
  const top2 = allProjects.find((project) => project.slug === "blaise.com")!;
  const top3 = allProjects.find((project) => project.slug === "blaise.com")!;
